...
/**
 * A titled settings section: an icon chip in the brand tint, a heading and a
 * one-line purpose, with an optional header action. Shared by the Email page's
 * Connection / Identity / Status cards so the three read as one system.
 */
