 ...
 * shape stays a rounded square (vs. the circular {@link UserAvatar}) so a team is never
 * mistaken for a person. A broken/expired image URL falls back to the crest.
 */
